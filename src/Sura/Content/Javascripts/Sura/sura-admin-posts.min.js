...
"Mo","Tu","We","Th","Fr","Sa"],weekHeader:"Wk",dateFormat:"mm/dd/yy",firstDay:0,isRTL:false,showMonthAfterYear:false,yearSuffix:""};this._defaults={showOn:"focus",showAnim:"fadeIn",showOptions:{},defaultDate:null,appendText:"",buttonText:"Select a time and date",buttonImage:"",buttonImageOnly:false,hideIfNoPrevNext:false,navigationAsDateFormat:false,gotoCurrent:false,changeMonth:false,changeYear:false,yearRange:"c-10:c+10",showOtherMonths:false,selectOtherMonths:false,showWeek:false,calculateWeek:this.iso8601Week,shortYearCutoff:"+10",
    ...
    $.fn.tagInput = function (options) {
        ...
        $(this).each(function () {
            ...
            if (input.is(':input')) {
                ...
                var add = null;
                var tags = input.val().replace(/ /g, '').split(',');
                var values = [];
                for (index in tags) {
                ...
                if (input.attr('placeholder') != null) {
                    ...
                    add = $('<input placeholder="' + placeholder + '" class="placeholder" type="text" />', { type: 'text' });
                } else {
                    add = $('<input />', { type: 'text' });
                }
                ...
                add.bind('keyup', function () {
                    ...
                    auto_width(this);
                    var key = event.keyCode || event.which;
                    if (',' == String.fromCharCode(key) || options.seperator == key || key == 13) {
                        add_tag(this);
                        event.preventDefault();
                        return false;
                    }
                ...
                add.focus(function () {
                    ...
                    if (values.length < 1) {
                        $(this).attr('placeholder', placeholder).css('width', '150px');
                    }
